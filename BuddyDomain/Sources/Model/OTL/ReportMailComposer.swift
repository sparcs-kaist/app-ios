...
public struct ReportMailComposer {
  public static func compose(title: String, code: String, year: Int, semester: SemesterType, professorName: String, content: String) -> String? {
    let result =  """
