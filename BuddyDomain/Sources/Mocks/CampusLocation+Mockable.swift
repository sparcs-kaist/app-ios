...
extension CampusLocation: Mockable { }

public extension CampusLocation {
  static var mock: CampusLocation {
    mockList.first!
  }

  static var mockList: [CampusLocation] {
    [
      CampusLocation(
        name: "(E1) Main Gate",
        latitude: 36.365596,
