...
public final class V2ReviewUseCase: V2ReviewUseCaseProtocol, Sendable {
  // MARK: - Dependencies
  private let otlReviewRepository: OTLV2ReviewRepositoryProtocol

  // MARK: - Initialiser
  public init(otlReviewRepository: OTLV2ReviewRepositoryProtocol) {
