...
extension Lecture: Mockable {
  static var mock: Lecture {
    Lecture(
      ...
      department: Department(id: 709, name: LocalizedString(["ko": "건설및환경공학과", "en": "Civil and Environmental Engineering"]), code: "CE"),
      isEnglish: true,
      credit: 3,
      creditAu: 0,
      capacity: 25,
      ...
      examTimes: [
        ExamTime(
          description: LocalizedString(["ko": "월요일 13:00 ~ 15:45", "en": "Monday 13:00 ~ 15:45"]),
          day: .mon,
          begin: 780,
          end: 945
        )
  ...
  static var mockList: [Lecture] {
    [
      ...
      Lecture(
        ...
        examTimes: [
          ExamTime(
            description: LocalizedString(["ko": "화요일 13:00 ~ 15:45", "en": "Tuesday 13:00 ~ 15:45"]),
            day: .tue,
            begin: 780,
            end: 945
          )
      ...
      Lecture(
        ...
        examTimes: [
          ExamTime(
            description: LocalizedString(["ko": "수요일 09:00 ~ 11:45", "en": "Wednesday 09:00 ~ 11:45"]),
            day: .wed,
            begin: 540,
            end: 705
          )
      ...
      Lecture(
        ...
        examTimes: [
          ExamTime(
            description: LocalizedString(["ko": "목요일 13:00 ~ 15:45", "en": "Thursday 13:00 ~ 15:45"]),
            day: .thu,
            begin: 780,
            end: 945
          )
