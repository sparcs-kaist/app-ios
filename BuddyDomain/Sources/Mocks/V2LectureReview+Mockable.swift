//
//  V2LectureReview+Mockable.swift
//  BuddyDomain
//
...
extension V2LectureReview: Mockable { }

public extension V2LectureReview {
  static var mock: V2LectureReview {
    V2LectureReview(
      id: 28073,
      courseID: 16614,
      lectureID: 1884766,
      courseName: "Aerospace Engineering LaboratoryⅡ",
      professors: [
        V2Professor(id: 2269, name: "이상봉"),
        V2Professor(id: 2438, name: "이전윤")
      ],
      year: 2024,
      semester: .autumn,
  ...
  static var mockList: [V2LectureReview] {
    [
      V2LectureReview(
        id: 28073,
        courseID: 16614,
